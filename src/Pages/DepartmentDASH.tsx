  ...
  return (
    <div>
        <section className='flex justify-between items-center p-10'>
            ...
            <button className='border border-[#28574E] bg-[#28574E] rounded-md text-white text-center w-[194px] h-[54px]'>Book Appointment</button>
        </section>
        <section className='flex w-[1126px] h-[125px] m-4 border border-[#E6E3E3] rounded-md'>
            <div className='p-5 flex gap-2 w-full '>
                ...
                <h1>Search</h1>
                <div className='relative gap-5'><img src={searchVector} alt="" className="absolute left-3 top-1/2 -translate-y-1/2 w-5 h-5" /> 
